...
import controller.SearchMemberProfileController;

import view.MainView;
import view.util.ImageDisplay;

public class SearchMemberProfileScreen extends Panel {
	...
	public SearchMemberProfileScreen(MainView view) {
		this.view = view;
		...
		back.addActionListener(new SearchMemberProfileController(this));
	}
