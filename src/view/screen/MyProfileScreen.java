...
import controller.MyProfileController;

import view.MainView;
import view.util.ImageDisplay;

public class MyProfileScreen extends Panel {
	...
	public MyProfileScreen(MainView view) {
		this.view = view;
		...
		updateStatus = new Button("UpdateStatus");
		Status = new TextField("",30);
		updateStatus.addActionListener(new MyProfileController(this));
		back.addActionListener(new MyProfileController(this));
	}
	...
	public void setProfile(byte[] byt){
		...
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(0, 0, 2, 0);
		gbl.setConstraints(updateStatus, gbc);
		add(updateStatus);
