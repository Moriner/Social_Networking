...
import controller.SavedMessageDetailController;
 ...
 *
 */
public class SavedMessageDetailScreen extends Panel{
	...
	public SavedMessageDetailScreen(MainView view) {
		this.view = view;
		...
		back.addActionListener(new SavedMessageDetailController(this));
	}
