...
import controller.AllMemberProfileController;

import view.MainView;
import view.util.ImageDisplay;

public class AllMemberProfileScreen extends Panel {
	...
	public AllMemberProfileScreen(MainView view) {
		this.view = view;
		...
		back.addActionListener(new AllMemberProfileController(this));
	}
